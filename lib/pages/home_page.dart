...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchDevices() async {
    final response = await http.get(Uri.parse('http://192.168.127.1:3000/device'));
  ...
  Future<void> toggleDeviceStatus(Device device) async {
    ...
    final response = await http.put(
      Uri.parse('http://192.168.127.1:3000/device/${device.id}'),
  ...
  Future<void> deleteDevice(String deviceId) async {
    final response = await http.delete(
      Uri.parse('http://192.168.127.1:3000/device/$deviceId'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return SmartDeviceBox(
                    smartDeviceName: device.namecategory,
                    iconPath: device.category.icon,
